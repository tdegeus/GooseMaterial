...
#ifndef GOOSEMATERIAL_AMORPHOUSSOLID_LINEARSTRAIN_ELASTOPLASTIC_SMOOTH_PLANARSHEAR_CARTESIAN3D_H
#define GOOSEMATERIAL_AMORPHOUSSOLID_LINEARSTRAIN_ELASTOPLASTIC_SMOOTH_PLANARSHEAR_CARTESIAN3D_H
