...
#ifndef GOOSEMATERIAL_AMORPHOUSSOLID_LINEARSTRAIN_ELASTOPLASTIC_SMOOTH_PLANARSHEAR_CARTESIAN2D_H
#define GOOSEMATERIAL_AMORPHOUSSOLID_LINEARSTRAIN_ELASTOPLASTIC_SMOOTH_PLANARSHEAR_CARTESIAN2D_H
...
inline double Material::energy(const T2s &Eps)
{
  ...
  double Vs = -2.*m_G * std::pow(deps_y/M_PI,2.) * ( 1. + cos( M_PI/deps_y * (epss-eps_min) ) );
