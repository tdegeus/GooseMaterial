...
% This corresponds to a non-linear relation between the Cauchy stress, $\bm{\sigma}$, and the linear strain increment, $\bm{\varepsilon}_\Delta$, depending on the equivalent plastic strain, $\varepsilon_\mathrm{p}$. I.e.
% %
% \begin{equation*}
%   \bm{\sigma}
%   =
